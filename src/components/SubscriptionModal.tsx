...
export function SubscriptionModal({
  ...
  const totalCharge = billingCycle === 'yearly' 
      ...
      <div style={{ 
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-8)' }}>
          ...
          <div style={{
            ...
            <HardHat size={20} style={{ color: 'var(--secondary-green)' }} />
            <span style={{ 
              fontSize: 'var(--text-label)',
              fontWeight: 'var(--font-weight-medium)',
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-8)' }}>
          ...
          {(isExpanded || billingCycle === 'yearly') && (
            <div 
              ...
              style={{
                padding: '10px 12px',
                border: billingCycle === 'yearly' ? '1px solid var(--secondary-green)' : '1px solid var(--grey-03)',
                borderRadius: 'var(--radius-8)',
                backgroundColor: 'var(--white)',
                cursor: 'pointer',
                display: 'flex',
            ...
            >
              <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-4)' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--spacing-8)' }}>
                  ...
                  <Tag variant="basic" color="primary" appearance="fill">Save 20%</Tag>
                </div>
              </div>
              {billingCycle === 'yearly' && (
                <Check size={16} style={{ color: 'var(--secondary-green)', flexShrink: 0 }} />
              )}
            </div>
          )}
          ...
          {(isExpanded || billingCycle === 'monthly') && (
            <div 
              ...
              style={{
                padding: '10px 12px',
                border: billingCycle === 'monthly' ? '1px solid var(--secondary-green)' : '1px solid var(--grey-03)',
                borderRadius: 'var(--radius-8)',
                backgroundColor: 'var(--white)',
                cursor: 'pointer',
                display: 'flex',
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-8)' }}>
          <p style={{ 
            ...
            You'll be charged <span style={{ fontWeight: 'var(--font-weight-medium)' }}>{totalCharge}.</span>
          </p>
          <p style={{ 
            fontSize: 'var(--text-caption)',
            color: 'var(--text-secondary)',
      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          {benefits.map((benefit, index) => (
            ...
            >
              <Check size={16} style={{ color: 'var(--secondary-green)', flexShrink: 0, marginTop: '2px' }} />
              <span style={{ 
                fontSize: 'var(--text-caption)',
                color: 'var(--text-primary)',
                lineHeight: '16px',
