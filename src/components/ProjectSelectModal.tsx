...
export function ProjectSelectModal({ isOpen, onClose, onSelect, className = "" }: ProjectSelectModalProps) {
            ...
            <div className="flex flex-col gap-4 w-full max-h-[300px] overflow-y-auto">
              {filteredProjects.length > 0 ? (
                ...
                <div className="text-center py-4">
                  <p style={{ color: 'var(--grey-05)', fontWeight: 'var(--font-weight-regular)' }}>
                    No projects found
                  </p>
                </div>
              )}
...
export type { Project, ProjectSelectModalProps };
