...
export function Calendar({ selectedDate, onSelect, onClose, className = "" }: CalendarProps) {
  ...
  return (
    <div 
      className={`w-[360px] bg-white rounded-lg border shadow-[0px_5px_12px_0px_rgba(0,0,0,0.1)] py-2 ${className}`}
