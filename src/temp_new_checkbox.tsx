          ...
          {activeSection === 'checkbox' && (
            <section>
              ...
              <div style={{ marginBottom: 'var(--spacing-56)' }}>
                <h3 style={{ fontWeight: 'var(--font-weight-semibold)', marginBottom: 'var(--spacing-8)' }}>1. Basic (Without Label)</h3>
                <TabsContainer
                  ...
                  <TabPanel value="preview" activeTab={checkboxBasicTab}>
                    <div className="component-card">
                      <div className="grid grid-cols-2 gap-8">
                        <div>
                          <p className="text-web-metadata-primary text-metadata mb-3">CIRCULAR</p>
                        ...
                        <div>
                          <p className="text-web-metadata-primary text-metadata mb-3">RECTANGULAR</p>
                          <div className="flex flex-col gap-3">
...
/>`}
              ...
              <div style={{ marginBottom: 'var(--spacing-56)' }}>
                <h3 style={{ fontWeight: 'var(--font-weight-semibold)', marginBottom: 'var(--spacing-8)' }}>2. With Label</h3>
                <TabsContainer
...
/>`}
              ...
              {/* Section 3: Size */}
              <div style={{ marginBottom: 'var(--spacing-56)' }}>
                <h3 style={{ fontWeight: 'var(--font-weight-semibold)', marginBottom: 'var(--spacing-8)' }}>3. Size</h3>
                <TabsContainer
                  activeTab={checkboxSizeTab}
                  onTabChange={setCheckboxSizeTab}
                  tabs={[
                    { value: 'preview', label: 'Preview' },
                    { value: 'usage', label: 'Usage' }
                  ]
                }>
                  <TabPanel value="preview" activeTab={checkboxSizeTab}>
                    <div className="component-card">
                      <div className="grid grid-cols-2 gap-8">
                        <div>
                          <p className="text-web-metadata-primary text-metadata mb-3">CIRCULAR (20px fixed)</p>
                          <Checkbox label="Fixed size 20x20px" variant="circular" />
                        </div>
                        <div>
                          <p className="text-web-metadata-primary text-metadata mb-3">RECTANGULAR (20px fixed)</p>
                          <Checkbox label="Fixed size 20x20px" variant="rectangular" />
                        </div>
                      </div>
                    </div>
                  </TabPanel>
                  <TabPanel value="usage" activeTab={checkboxSizeTab}>
                    <CodeExample
                      title="Checkbox Size"
                      code={`import { Checkbox } from './components';

// Checkboxes have a fixed size of 20x20 pixels
<Checkbox variant="circular" label="Fixed size checkbox" />`}
                    />
                  </TabPanel>
                </TabsContainer>
              </div>
              ...
              {/* Section 4: States */}
              <div style={{ marginBottom: 'var(--spacing-56)' }}>
                <h3 style={{ fontWeight: 'var(--font-weight-semibold)', marginBottom: 'var(--spacing-8)' }}>4. States</h3>
                <TabsContainer
                  ...
                  <TabPanel value="preview" activeTab={checkboxStatesTab}>
                    <div className="component-card">
                      <div className="space-y-6">
                        <div>
                          <p className="text-web-metadata-primary text-metadata mb-3">DEFAULT STATE</p>
                          <div className="grid grid-cols-2 gap-8">
                            <div className="flex flex-col gap-3">
