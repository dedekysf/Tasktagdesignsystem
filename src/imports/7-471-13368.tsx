import svgPaths from "./svg-ggxc7bm8az";
...
function Content() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-h-px min-w-px not-italic relative text-white whitespace-pre-wrap" data-name="Content">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] relative shrink-0 text-[16px] w-full">Don’t Work Alone</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] relative shrink-0 text-[12px] tracking-[0.24px] w-full">Projects run better with others. Invite someone to collaborate on this project.</p>
    </div>
  );
}
