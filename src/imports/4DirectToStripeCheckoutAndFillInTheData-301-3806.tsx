import svgPaths from "./svg-evwdu5bhco";
  ...
  return (
    <div className="relative shrink-0 size-[28px]" data-name="icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 28 28">
        <g id="icon">
          <path clipRule="evenodd" d={svgPaths.p2aff5700} fill="var(--fill-0, #0A1629)" fillRule="evenodd" id="Vector (Stroke)" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="absolute inset-[0_0_-0.01%_0]" data-name="Group">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 135 40.0027">
        <g id="Group">
          <path d={svgPaths.p38c93200} fill="var(--fill-0, #00D9A5)" id="Vector" />
          <path d={svgPaths.p99e7200} fill="var(--fill-0, #00D9A5)" id="Vector_2" />
          <path d={svgPaths.p2cc33a00} fill="var(--fill-0, #00D9A5)" id="Vector_3" />
          <path d={svgPaths.p2719c700} fill="var(--fill-0, #00D9A5)" id="Vector_4" />
          <path d={svgPaths.p16c3cf70} fill="var(--fill-0, #00D9A5)" id="Vector_5" />
          <path d={svgPaths.p2694980} fill="var(--fill-0, black)" id="Vector_6" />
          <path d={svgPaths.p3180a1c0} fill="var(--fill-0, black)" id="Vector_7" />
          <path d={svgPaths.p384ab600} fill="var(--fill-0, black)" id="Vector_8" />
          <path d={svgPaths.p144af700} fill="var(--fill-0, black)" id="Vector_9" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_301_3824)" id="icon">
          <path clipRule="evenodd" d={svgPaths.p106dc80} fill="var(--fill-0, #0A1629)" fillRule="evenodd" id="Vector (Stroke)" />
        </g>
        <defs>
          <clipPath id="clip0_301_3824">
  ...
  return (
    <div className="absolute inset-[18.7%_13.04%_19.51%_14.91%]" data-name="Mastercard">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.292 10.5039">
        <g id="Mastercard">
          <path d={svgPaths.p2225a800} fill="var(--fill-0, #ED0006)" id="Left" />
          <path d={svgPaths.p3723eb40} fill="var(--fill-0, #F9A000)" id="Right" />
          <path d={svgPaths.p1025b900} fill="var(--fill-0, #FF5E00)" id="Middle" />
        </g>
      </svg>
    </div>
  );
